            ...
            {hook name="wk_datagrid:table"}
                <table width="100%" class="table table-middle table--relative table-responsive table--overflow-hidden table--show-checkbox table-manage-orders">
                    <thead data-ca-bulkedit-default-object="true" data-ca-bulkedit-component="defaultObject">
                        {include file="addons/wk_datagrid/components/table/head.tpl" columns=$data.columns column_width=$column_width}                        
                    </thead>                

                    <tbody>
                        {include file="addons/wk_datagrid/components/table/body.tpl" columns=$data column_width=$column_width}                        
                    </tbody>
...
{* Get advanced search *}
{include file="addons/wk_datagrid/components/search/search.tpl"
    search=$search
...
{include file="addons/wk_datagrid/components/search/get_search_filters.tpl"
    search=$search
    dispatch=$search_form_dispatch

<div class="ty-period">
    <div class="ty-control-group ty-period__wrapper">
        ...
        <select class="ty-period__select" name="filters[{$field_name}][period]" id="period_selects">
    ...
    <div class="ty-control-group ty-period__select-date calendar">
        ...
        {include file="common/calendar.tpl" date_id="f_date" date_name="filters[{$field_name}][time_from]" date_val=$filter_value.time_from start_year=$settings.Company.company_start_year extra="onchange=\"Tygh.$('#period_selects').val('C');\""}
        <span class="ty-period__dash">&#8211;</span>
        {include file="common/calendar.tpl" date_id="t_date" date_name="filters[{$field_name}][time_to]" date_val=$filter_value.time_to  start_year=$settings.Company.company_start_year extra="onchange=\"Tygh.$('#period_selects').val('C');\""}
    </div>

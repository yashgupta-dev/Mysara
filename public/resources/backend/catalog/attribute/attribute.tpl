            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        {include file="backend/common/btn.tpl" title=$lang.text_add_attribute color="primary" href="admin.php?dispatch=catalog.attribute.add"}
                        {include file="backend/common/btn.tpl" title=$lang.text_group_attribute_group color="primary" href="admin.php?dispatch=catalog.group"}

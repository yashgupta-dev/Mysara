...
<head>
  ...
  <link rel="stylesheet" href="/public/assets/auth/style.css" />
  <link href="/public/assets/css/toaster/toastr.min.css" rel="stylesheet">
              ...
              <div class="row">
                <div class="col-md-4 pr-md-0">
                  <div class="auth-left-wrapper"
                    style="background-image: linear-gradient(to right, #ab3c3c26,#7f9cf552),url('/public/assets/img/pattern_5.png');">
                  </div>
                </div>
                <div class="col-md-8 pl-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    ...
                    <form action="/sign-in" method="post" role="form" class="forms-sample form-ajax p-3 p-md-4">
